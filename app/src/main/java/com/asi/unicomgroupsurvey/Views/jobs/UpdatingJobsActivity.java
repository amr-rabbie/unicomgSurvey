...
public class UpdatingJobsActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nextClick.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Toast.makeText(UpdatingJobsActivity.this, "من فضلك أدخل وظيفة علي الاقل", Toast.LENGTH_LONG).show();
                }
                else {
                    startActivity(new Intent(UpdatingJobsActivity.this, UpdateRoomsActivity.class));
                }
            }
        });
    ...
    public void onBackPressed() {
        ...
        if (drawer.isDrawerOpen(GravityCompat.START)) {
            ...
            UpdatingJobsActivity.super.onBackPressed();
 ...
 */
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.show_saved_data_list) {
            Intent i=new Intent(UpdatingJobsActivity.this,GetOfflineSavedSurveyActivity.class);
            startActivity(i);
        } else if (id == R.id.add_new_survey) {

            Intent intent = new Intent(UpdatingJobsActivity.this , NavigationHomeActivity.class);
            intent.putExtra("project_name" , Constants.getProjectName(UpdatingJobsActivity.this));
            ...
            builder = new android.app.AlertDialog.Builder(UpdatingJobsActivity.this);
            builder.setMessage("هل حقا تريد تسجيل الخروج ؟");
            builder.setPositiveButton("نعم", new DialogInterface.OnClickListener() {
                @Override
                public void onClick(DialogInterface dialog, int which) {
                    Constants.saveLoginData("", "", "", UpdatingJobsActivity.this);
                    Intent i = new Intent(UpdatingJobsActivity.this, LoginActivity.class);
                    startActivity(i);
                    dialog.dismiss();
                }
            });
    ...
    private void attachAddCommentsFragment() {
     startActivity(new Intent(this , CommentsActivity.class));
    }
        ...
        addBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(jobTitle.equals("اختر الوظيفة")){
                    Toast.makeText(UpdatingJobsActivity.this,
                    ...
                    Toast.makeText(UpdatingJobsActivity.this, "برجاء ادخال جميع الحقول المطلوبة واختيار الوظيفة", Toast.LENGTH_LONG).show();


                } else if (count.getText().toString().trim().isEmpty()) {
                    count.setError("برجاء ادخال العدد");
                } else if (jobTitle.equals("--أختر--")) {
                    Toast.makeText(UpdatingJobsActivity.this, "اختر ليست وظيفه", Toast.LENGTH_LONG).show();
                } else {

                    if (mainPresenter.isFounded(jobID , Constants.getOfficeId(UpdatingJobsActivity.this) ,Constants.getProjectId(UpdatingJobsActivity.this) , Constants.getuserId(UpdatingJobsActivity.this))) {
                        Toast.makeText(UpdatingJobsActivity.this, "هذه الوظيفة مضافة من قبل ", Toast.LENGTH_LONG).show();
                    } else {
                        Toast.makeText(UpdatingJobsActivity.this, "تم أضافة(" + jobTitle + ")كوظيفة جديدة ", Toast.LENGTH_LONG).show();
                        Job job = new Job(Constants.getuserId(UpdatingJobsActivity.this),
                                Constants.getProjectId(UpdatingJobsActivity.this),
                                Constants.getOfficeId(UpdatingJobsActivity.this),
                                jobID,
    ...
    public void showUpdateDialog(Job job) {
        LayoutInflater li = LayoutInflater.from(this);
        final View promptsView = li.inflate(R.layout.edit_job_dialog, null);
        final Dialog dialog = new Dialog(this);
        dialog.setCancelable(false);
        ...
        addBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (notes.getText().toString().trim().isEmpty() && count.getText().toString().trim().isEmpty() &&
                    ...
                    Job job = new Job(Constants.getuserId(UpdatingJobsActivity.this), Constants.getProjectId(UpdatingJobsActivity.this), Constants.getOfficeId(UpdatingJobsActivity.this),
                            jobID,
                            count.getText().toString(),
                            notes.getText().toString(),
                            jobTitle);
