...
*/
    ...
    private void getData2() {
        String userid=Constants.getuserId(NotesActivity.this);
        String officeid=Constants.getOfficeId(NotesActivity.this);
        String projectid=Constants.getProjectId(NotesActivity.this);
        ...
        for(int i=0; i < notesoffline.size() ; i++){
            ...
            Toast.makeText(NotesActivity.this, notes.getNotes() + " - " + notes.getLocation(), Toast.LENGTH_SHORT).show();
        }
    }
    ...
    public void onBackPressed() {
        ...
        if (drawer.isDrawerOpen(GravityCompat.START)) {
            ...
            notesPresenter.saveNotesoffline(officeid,note,loc,userid,projectid , formattedDate,electricty ,water ,bill_end ,colunms ,doors ,secondary ,camers);
    ...
    protected void onResume() {
        ...
        if(notesoffline.size() > 0) {
            for (int i = 0; i < notesoffline.size(); i++) {
                notes = notesoffline.get(i);
            }
            edt_notes.setText(notes.getNotes()+"");
            tvLatLang.setText(notes.getLocation());
...
//
//
//                /*String loc=notes.getLocation();
//                String date=notes.getVisit_date();
//                String note=notes.getNotes();
//                String elc=notes.getElectricty();
//                String wat=notes.getWater();
//
//
//                Toast.makeText(NotesActivity.this, "Loc: " + notes.getNotes(), Toast.LENGTH_SHORT).show();
//                Toast.makeText(NotesActivity.this, "Date: " + notes.getVisit_date(), Toast.LENGTH_SHORT).show();
//                Toast.makeText(NotesActivity.this, "ele: " + notes.getElectricty(), Toast.LENGTH_SHORT).show();
//                Toast.makeText(NotesActivity.this, "wat: " + notes.getWater(), Toast.LENGTH_SHORT).show();
//                Toast.makeText(NotesActivity.this, "col: " + notes.getColunms(), Toast.LENGTH_SHORT).show();
//                Toast.makeText(NotesActivity.this, "Notes: " + notes.getNotes(), Toast.LENGTH_SHORT).show();*/
//
//
//                edt_notes.setText("" + notes.getNotes());
//                tvLatLang.setText("" + notes.getLocation());
           ...
           getLocation();
            ...
            handler.postDelayed(new Runnable() {
                ...
                public void run() {
                    ...
                    gpsTracker = new GpsTracker(NotesActivity.this);
                    ...
                    editor.apply();*/
                        ...
                        Constants.savelanglat(lang, lat, NotesActivity.this);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.show_saved_data_list) {
            Intent i=new Intent(NotesActivity.this,GetOfflineSavedSurveyActivity.class);
            startActivity(i);
        } else if (id == R.id.add_new_survey) {
            Intent intent = new Intent(NotesActivity.this , NavigationHomeActivity.class);
            intent.putExtra("project_name" , Constants.getProjectName(NotesActivity.this));
    ...
    public void saveData(View view) {
        try {
            ...
            notesPresenter.saveNotesoffline(officeid,note,loc,userid,projectid, vacdate,electricty,water,bill_end,colunms,doors,secondary,camers);


            Intent i=new Intent(NotesActivity.this,SendingDataSucessActivity.class);
            startActivity(i);
        }
        catch (Exception e) {
            Toast.makeText(NotesActivity.this, "من فضلك اعد المحاوله ", Toast.LENGTH_SHORT).show();
